TRANSLATIONS = {
    "ES": {
        # MAIN VIEW
        "STAGES_SECTION": ["Sesión", "Trabajo", "Descanso"],
        "BUTTONS": ["Iniciar", "Detener", "Estadísticas", "Tareas", "Restablecer"],
        # CONFIG PANEL
        "APP_BAR": ["Configuración", "Guardar"],
        "COUNTERS": ["Tiempo de trabajo", "Tiempo de descanso", "Tiempo de descanso largo"],
        "THEMES": ["Claro", "Oscuro"],
    ...
    "EN": {
        # MAIN VIEW
        "STAGES_SECTION": ["Session", "Work", "Free"],
        "BUTTONS": ["Start", "Stop", "Stats", "Tasks", "Undo"],
        # CONFIG PANEL
        "APP_BAR": ["Configuration", "Save"],
        "COUNTERS": ["Work time", "Free time", "Long free time"],
        "THEMES": ["Light", "Dark"],
